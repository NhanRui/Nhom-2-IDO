...
} from "../contexts/IDOInteractContext";
...
const onLoading = (
  <Stack spacing={8} alignItems={"center"} overflow={"hidden"}>
...
let whitelistedEl = (
  <Tag alignSelf={"flex-start"} size="sm" variant="outline">
      ...
      <Stack>
        <Stack direction={"row"} spacing={2}>
          ...
          {whitelisted !== undefined &&
            (whitelisted ? whitelistedEl : whitelistedntEl)}
        </Stack>
